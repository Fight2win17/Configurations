...
#define CONFIG_EXAMPLES_DIR "config/examples/Ultimaker/Ultimaker Original Plus DXU" 
 ...
 */
   ...
   */
  #define DISPLAY_SLEEP_MINUTES 30  // (minutes) Timeout before turning off the screen. Set with M255 S.
